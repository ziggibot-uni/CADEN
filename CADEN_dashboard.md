...
- Chat echoes become events with embeddings.
...
- **CADEN still does not schedule anything past today.** The 7-day
  view is read + preview, not plan. Per spec: "His scope stays small."
